// this library is written by nerdenough, and can be found here: https://github.com/nerdenough/luxafor
//
// it couldn't be installed normally via npm due to a breaking outdated dependency, so it's included like this as-is
